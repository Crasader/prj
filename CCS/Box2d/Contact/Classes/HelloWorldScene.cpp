...
void HelloWorld::SetBox2dWorld()
{
	...
	this->addNewSpriteAtPosition(Vec2(100, 160), Size(32, 32), b2_dynamicBody, "test", 0);

	this->addNewSpriteAtPosition(Vec2(300, 160), Size(32, 32), b2_dynamicBody, "test", 0);
}
