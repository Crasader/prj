...
void HelloWorld::SetBox2dWorld()
{
	...
	myBall = this->addNewSpriteAtPosition(Vec2(25, 50), Size(50, 50), b2_dynamicBody, "test", 0);
	...
	//{
	//	this->addNewSpriteAtPosition(blocks[i].point, blocks[i].size, b2_dynamicBody, "test", 0);
	//}


	this->addNewSpriteAtPosition(Vec2(200, 1), Size(50, 50), b2_dynamicBody, "test", 0);
	this->addNewSpriteAtPosition(Vec2(200, 52), Size(200, 10), b2_dynamicBody, "test", 0);
	this->addNewSpriteAtPosition(Vec2(200+75, 54), Size(25, 25), b2_dynamicBody, "test", 0);
}
