...
bool HelloWorld::init()
{
	...
	texture = Director::getInstance()->getTextureCache()->addImage("f1.png");
...
void HelloWorld::addNewSpriteAtPosition(Vec2 location)
{
	...
	polygon->setPosition(Vec2(location));
	
	Sprite *pSprite = Sprite::createWithTexture(texture, Rect(0, 0, 158, 92));
	...
	MyBodyParser::getInstance()->parseJsonFile("ex1.json");
	MyBodyParser::getInstance()->b2BodyJson(polygon, "Forward", body);
