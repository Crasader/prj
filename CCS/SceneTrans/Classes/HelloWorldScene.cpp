...
bool HelloWorld::init()
{
	...
	auto item1 = MenuItemFont::create(
		"pushScene", CC_CALLBACK_1(HelloWorld::doPushScene, this));
	auto item2 = MenuItemFont::create(
		"pushScene, Transition", CC_CALLBACK_1(HelloWorld::doPushSceneTrans, this));
	auto item3 = MenuItemFont::create(
		"replaceScene", CC_CALLBACK_1(HelloWorld::doReplaceScene, this));
	auto item4 = MenuItemFont::create(
		"replaceScene, Transition", CC_CALLBACK_1(HelloWorld::doReplaceSceneTrans, this));

	auto pMenu = Menu::create(item1, item2, item3, item4, NULL);
...
void HelloWorld::doPushSceneTrans(Ref *pSender)
{
	auto pScene = TestScene2::createScene();
	Director::getInstance()->pushScene(createTransition(7, 2, pScene));
}
...
void HelloWorld::doReplaceSceneTrans(Ref *pSender)
{
	auto pScene = TestScene3::createScene();
	Director::getInstance()->replaceScene(createTransition(17,2,pScene));
}
