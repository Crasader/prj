...
void HelloWorld::SetBox2dWorld()
{
	...
	b2Body* body1 = this->addNewSpriteAtPosition(Vec2(240, 280), Size(40, 40),
		b2_dynamicBody, "test", 0);
	b2Body* body2 = this->addNewSpriteAtPosition(Vec2(340, 280), Size(40, 40),
		b2_dynamicBody, "test", 0);

	frictionJointDef.Initialize(body1, body2, body1->GetPosition());
	frictionJointDef.maxForce = 500;
