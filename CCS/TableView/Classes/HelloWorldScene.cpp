...
bool HelloWorld::init()
{
	...
	TableView* tableView = TableView::create(this, Size(350, 120));
	...
	if (!cell) {
		if (table->getTag() == 200)
		{
			if (idx % 6 == 0)
			{
				...
				cell->autorelease();
				auto sprite = Sprite::create("Images/nyan.png");
				sprite->setAnchorPoint(Vec2::ZERO);
				sprite->setPosition(Vec2(0, 0));
				cell->addChild(sprite);

				auto label = Label::createWithSystemFont("NYAN!", "Helvetica", 20.0);
