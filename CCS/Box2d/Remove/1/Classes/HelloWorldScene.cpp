...
{
	this->addNewSpriteAtPosition(Vec2(80, 160), Size(32, 32), b2_dynamicBody, "test", 0);
	this->addNewSpriteAtPosition(Vec2(160, 160), Size(32, 32), b2_dynamicBody, "test", 0);
	this->addNewSpriteAtPosition(Vec2(240, 160), Size(32, 32), b2_dynamicBody, "test", 0);
	this->addNewSpriteAtPosition(Vec2(320, 160), Size(32, 32), b2_dynamicBody, "test", 0);
	this->addNewSpriteAtPosition(Vec2(400, 160), Size(32, 32), b2_dynamicBody, "test", 0);
}
