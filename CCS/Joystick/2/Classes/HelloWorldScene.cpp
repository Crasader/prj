...
bool HelloWorld::init()
{
	...
	if (this->createBox2dWorld(false))
	{
		...
		this->addNewSpriteAtPosition(Vec2(240, 160), Size(90, 90), b2_dynamicBody, "SpinningPeas",0);
...
void HelloWorld::SetBox2dWorld()
{
	...
	// 바디를 생성해서 월드에 추가한다.
	b2Body* body1 = this->addNewSpriteAtPosition(Vec2(100, 160), Size(60, 60),
		b2_dynamicBody, "test", 0);
	b2Body* body2 = this->addNewSpriteAtPosition(Vec2(100, 140), Size(37, 37),
	...
	b2Body* body3 = this->addNewSpriteAtPosition(Vec2(200, 160), Size(60, 60),
		b2_dynamicBody, "test", 0);
	b2Body* body4 = this->addNewSpriteAtPosition(Vec2(200, 140), Size(37, 37),
		b2_dynamicBody, "SpinningPeas.png", 0);
	...
	//revJointDef.motorSpeed = 50; // radians per second. 1 radian = 180/pi degrees
	//revJointDef.maxMotorTorque = 200; // 회전력
		...
		const char* spriteName,int type)
{
	...
	if (spriteName)
	{
		...
		{
			Sprite* sprite = Sprite::create("SpinningPeas.png");
			sprite->setPosition(point);
			this ->addChild(sprite);
			bodyDef.userData = sprite;
		}
