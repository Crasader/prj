...
void HelloWorld::SetBox2dWorld()
{
	...
	b2Body* body1 = this->addNewSpriteAtPosition(Vec2(200, 150), Size(40, 40),
		b2_dynamicBody, "test", 0);
	b2Body* body2 = this->addNewSpriteAtPosition(Vec2(300, 150), Size(40, 40),
		b2_dynamicBody, "test", 0);
	...
	pulleyJointDef.Initialize(body1,
		body2,
		b2Vec2(200 / PTM_RATIO, 200 / PTM_RATIO),
