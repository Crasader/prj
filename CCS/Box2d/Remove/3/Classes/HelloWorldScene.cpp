...
void HelloWorld::SetBox2dWorld()
{
	...
	// 바디를 생성해서 월드에 추가한다.
	b2Body* body1 = this->addNewSprite(Vec2(100, 160), Size(60, 60),
		b2_dynamicBody, "test", 0);
	b2Body* body2 = this->addNewSprite(Vec2(100, 140), Size(37, 37),
	...
	b2Body* body3 = this->addNewSprite(Vec2(200, 160), Size(60, 60),
		b2_dynamicBody, "test", 0);
	b2Body* body4 = this->addNewSprite(Vec2(200, 140), Size(37, 37),
		b2_dynamicBody, "SpinningPeas.png", 0);
