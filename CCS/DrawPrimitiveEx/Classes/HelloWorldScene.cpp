...
void HelloWorld::onDraw(const Mat4 &transform, uint32_t flags)
{
	...
	DrawPrimitives::drawCubicBezier(Vec2(240, 160), Vec2(Vec2(240, 160).x + 30, Vec2(240, 160).y + 50), Vec2(Vec2(240, 160).x + 60, Vec2(240, 160).y - 50), Vec2(480, 160), 100);
...
void HelloWorld::DrawSec()
{
	...
	draw->drawCubicBezier(Vec2(240, 160), Vec2(Vec2(240, 160).x + 30, Vec2(240, 160).y + 50), Vec2(Vec2(240, 160).x + 60, Vec2(240, 160).y - 50), Vec2(480, 160), 100, Color4F(CCRANDOM_0_1(), CCRANDOM_0_1(), CCRANDOM_0_1(), 0.5));
