...
void HelloWorld::SetBox2dWorld()
{
	...
	b2Body* body0 = this->addNewSpriteAtPosition(Vec2(240, 160), Size(160, 60),
		b2_staticBody, nullptr, 0);
	b2Body* body1 = this->addNewSpriteAtPosition(Vec2(240 - 40, 160), Size(40, 40),
		b2_dynamicBody, nullptr, 1);
	b2Body* body2 = this->addNewSpriteAtPosition(Vec2(240 + 20, 160), Size(80, 80),
		b2_dynamicBody, nullptr, 1);
